...
const Images: images = {
  ...
  destination: require("../../assets/images/onBoarding/tricycle/destination.png"),
  // bookRide: require("../../assets/images/onBoarding/bookRide.png"),
  bookRide: require("../../assets/images/onBoarding/tricycle/bookRide.png"),
  // trip: require("../../assets/images/onBoarding/trip.png"),
  trip: require("../../assets/images/onBoarding/tricycle/trip.png"),
